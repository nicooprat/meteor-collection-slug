...
CollectionBehaviours.define('slug', function(opts = {}) {
  ...
  if (c2 != null) {
    ...
    definition[options.destination] = {
      type: String,
      optional: true,
      defaultValue: ''
    };
  ...
  this.collection.before.insert((userId, doc) => {
    if( !_.isEmpty(doc[options.source]) ) {
      doc[options.destination] = sluggify(doc[options.source]);
    }
  });
